    ...
    conditionalPanel(
      ...
      tags$small(class = "text-muted d-block mb-1",
                 paste("Permite diseños pareados (~ subject + condition),",
                       ...
                       "de ajustar.")),
      selectInput("deg_continuous_vars", "Variables continuas", choices = NULL,
                  multiple = TRUE, width = "100%"),
      tags$small(class = "text-muted d-block mb-1",
                 paste("Lo que NO marques aqui se ajusta como factor. Importa",
                       "en los diseños pareados: un identificador de sujeto es",
                       "numerico, pero es un bloque y no una pendiente.")),
